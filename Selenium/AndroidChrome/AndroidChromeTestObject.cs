...
namespace Selenium.AndroidChrome
{
    public class AndroidChromeTestObject : ITestObject
    {
        ...
        public AndroidChromeTestObject(IBrowser browser, ITestObjectLocator toLocator, IToolDependencyResolver resolver)
        {
