...
namespace Selenium.Firefox
{
    public class FirefoxTestObject : ITestObject
    {
        ...
        public string GetFieldValue()
        {
            ...
            IJavaScriptExecutor js = (IJavaScriptExecutor)GetDriver();
            string value = js.ExecuteScript(script, GetAutomationElement()).ToString();
            return value;
        }
        ...
        public string GetCssValue(string propName)
        {
            string propValue = "";
                ...
                IJavaScriptExecutor js = (IJavaScriptExecutor)GetDriver();
                propValue = js.ExecuteScript(script, GetAutomationElement(), propName).ToString();
        ...
        public void SendKeys(string value)
        {
            ...
            script += "return 'true';";
            JSExecuter.Execute(script, new object[] { GetAutomationElement(), value });
            if(GetFieldValue() != value)
            {
                System.Console.WriteLine("Script Retried Under SendKeys for Value =>" + value);
                JSExecuter.Execute(script, new object[] { GetAutomationElement(), value });
            }
        ...
        public string GetXPathTo<IWebElement>(IWebElement element)
        {
            ...
            string xpath = js.ExecuteScript(script, element).ToString();
            if (xpath.EndsWith("[1]"))
        ...
        private string GetBorderColorHexValue()
        {
            ...
            borderColor = GetCssValue("border-top-color");
        ...
        private bool IsThisElementVisible()
        {
            ...
            IJavaScriptExecutor js = (IJavaScriptExecutor)GetDriver();
            string visibleProp = js.ExecuteScript(script, GetAutomationElement()).ToString();
            if (visibleProp == "True")
                return true;
            else
                return false;
