...
{
    public class FirefoxWaitFor : IWaitFor
    {
        ...
        public FirefoxWaitFor(IWebDriver driver, By locator)
        {
            _driver = driver;
            _locator = locator;
        ...
        public void ElementClassDoesNotContain(string text)
        {
            ...
            {
                System.Console.WriteLine("TimeOut while trying in ElementClassDoesNotContain() => " + _locator.ToString() + ", text-" + text);
            }
